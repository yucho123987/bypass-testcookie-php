 ...
 * Copyright (c) 2024 Yucho
 * GitHub: https://github.com/yucho123987/bypass-testcookie-php
*/
...
function parseabc($html) {
  $a = explode('")', explode('a=toNumbers("', $html)[1])[0];
  $b = explode('")', explode('b=toNumbers("', $html)[1])[0];
  $c = explode('")', explode('c=toNumbers("', $html)[1])[0];
  return [$a, $b, $c];
}
?>
